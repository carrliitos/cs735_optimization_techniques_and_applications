$title Problem 8-2 (MIP) Traveling Salesman with MTZ Formulation
...
cons3(i,j) "MTZ Constraints",
cons4(i) "No self-loops";
...
cons3(i,j)..
  u(i) - u(j) + (card(i)-1)*x(i,j) =l= card(i)-2;
...
file hw8_2results / hw8_2results.txt/;
put hw8_2results 'Solution 2'/;
